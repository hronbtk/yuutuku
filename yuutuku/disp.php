...
<body>
    <?php
        ...
        if($kinds=='monster'){
            ...
            $sql='SELECT code,name,furigana,img_name,kinds_monster,tuner,pORnot,scale,penduramu_text,element,lebel,species,atk,def,text FROM monstercard_data where name=?';
