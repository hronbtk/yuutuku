    ...
    if($kinds=='monster'){
        if(isset($post['link'])==true){
            ...
            try{
                ...
                $sql='INSERT INTO link_monstercard_data(kinds,name,furigana,img_name,element,link_number,species,atk,text,ue,sita,hidari,migi,hidariue,migiue,hidarisita,migisita) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
            ...
            try{
                ...
                $sql='INSERT INTO monstercard_data(kinds,name,furigana,img_name,kinds_monster,tuner,pORnot,scale,penduramu_text,element,lebel,species,atk,def,text) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
                $stmt=$dbh->prepare($sql);
                $data[]=$kinds;
                $data[]=$cardname;
                $data[]=$card_name_hurigana;
