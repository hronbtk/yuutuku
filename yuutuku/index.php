    ...
    <script>
        $(".kinds").change(function(){
            ...
            if(kinds=='monster'){
                ...
                $('.attack_guard').html('<br>攻撃力/<input type="number" name="atk"><br>守備力/<input type="number" name="def">')
                $('.kinds-magic').html('');
                $('.kinds-trap').html('');
            }
            if(kinds=='magic'){
            ...
            if(kinds=='trap'){
                $('.kinds-trap').html('<select name="kinds-trap"><option value="通常">通常</option><option value="永続">永続</option><option value="カウンター">カウンター</option></select><!-- /# -->');
                $('.kinds-magic').html('');
                $('.kinds-monster').html('');
                $('.element').html('');
                $('.species').html('');
