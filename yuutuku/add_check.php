...
<body>
    ...
    <div class="wrapper">
        ...
        <div>
            ...
            <?php
                if($kinds_monster=='通常'||$kinds_monster=='効果'){
                    echo '<div class=card_text_detail><span>【'.$species.'/'.$kinds_monster.'】</span><br>'.$text.'</div>';
                }else{
                    echo '<div class=card_text_detail><span>【'.$species.'/'.$kinds_monster.'/効果】</span><br>'.$text.'</div>';
                }
            ?>
        </div>
    </div>
